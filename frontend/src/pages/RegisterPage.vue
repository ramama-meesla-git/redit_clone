    ...
    <div class="auth-card">
      ...
      <form @submit.prevent="handleRegister" class="auth-form">
        ...
        <div class="form-group">
          <input v-model="form.username" type="text" class="input" placeholder="Choose a username" required minlength="3" />
        </div>
        ...
        <div class="form-group">
          <input v-model="form.confirmPassword" type="password" class="input" placeholder="Confirm Password" required />
        </div>
